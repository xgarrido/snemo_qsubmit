...
def usage ():
    print "\n  Script usage:"
    print "\n     qsubmit.py [Options] --config A_CONFIG_FILE"
    print "\n  Example:"
    print "\n     qsubmit.py --config dummy.conf"
    print "\n  Options:"
    print "\n  -h or --help  : print this help"
    print "\n  -d or --debug : debug logging"
    print "\n        --test  : test mode"
    print "\n"
...
def main (argv):
    ...
    try:
        opts, args = getopt.getopt (argv, "htc:", ["help", "debug", "test", "config="])
    except getopt.GetoptError:
        print "ERROR: qsubmit::main: Unknown argument :", argv
        usage ()
        sys.exit (2)
